...
namespace ChaunceEasyRedis
{
    public class RedisCache : IRedisCache
    {
        ...
        /// <returns></returns>
        public bool Set(string key, object obj, TimeSpan? expiry = default(TimeSpan?))
        {
            if (obj == null)
            {
            ...
            return Do(db => db.StringSet(key, entryBytes, expiry));
        }
        ...
        public T Get<T>(string key, Func<T> factory = null, TimeSpan? expiration = default(TimeSpan?)) where T : class
        {
            ArgumentCheck.NotNullOrWhiteSpace(key, nameof(key));
            string oldKey = key;
        ...
        /// <param name="expiration">Expiration.</param>
        /// <typeparam name="T">The 1st type parameter.</typeparam>
        public async Task<T> GetAsync<T>(string key, Func<Task<T>> factory = null, TimeSpan? expiration = default(TimeSpan?)) where T : class
        {
            ArgumentCheck.NotNullOrWhiteSpace(key, nameof(key));
            string oldKey = key;
            key = AddSysCustomKey(key);
            ...
            else
            {
                ...
                if (item != null)
                {
                    await SetAsync(oldKey, item, expiration);
                    return item;
                }
                return default(T);
            }
        ...
        public bool HashSet<T>(string key, string dataKey, T obj)
        {
            ...
            return Do(db =>
            {
                ...
                var entryBytes = Serialize(obj);
                return db.HashSet(key, dataKey, entryBytes);
            });
        }
        ...
        /// <param name="t"></param>
        /// <returns></returns>
        public async Task<bool> HashSetAsync<T>(string key, string dataKey, T obj)
        {
            key = AddSysCustomKey(key);
            return await Do(db =>
            {
                var entryBytes = Serialize(obj);
                return db.HashSetAsync(key, dataKey, entryBytes);
            });
        }
        ...
        public void ListRemove<T>(string key, T obj)
        {
            key = AddSysCustomKey(key);
            Do(db => db.ListRemove(key, Serialize(obj)));
        }
        ...
        /// <param name="key"></param>
        /// <param name="value"></param>
        public void ListRightPush<T>(string key, T obj)
        {
            key = AddSysCustomKey(key);
            Do(db => db.ListRightPush(key, Serialize(obj)));
        }
        ...
        /// <param name="key"></param>
        /// <param name="value"></param>
        public void ListLeftPush<T>(string key, T obj)
        {
            key = AddSysCustomKey(key);
            Do(db => db.ListLeftPush(key, Serialize(obj)));
        }
        ...
        /// <param name="key"></param>
        /// <param name="value"></param>
        public async Task<long> ListRemoveAsync<T>(string key, T obj)
        {
            key = AddSysCustomKey(key);
            return await Do(db => db.ListRemoveAsync(key, Serialize(obj)));
        }
        ...
        /// <param name="key"></param>
        /// <param name="value"></param>
        public async Task<long> ListRightPushAsync<T>(string key, T obj)
        {
            key = AddSysCustomKey(key);
            return await Do(db => db.ListRightPushAsync(key, Serialize(obj)));
        }
        ...
        /// <param name="key"></param>
        /// <param name="value"></param>
        public async Task<long> ListLeftPushAsync<T>(string key, T obj)
        {
            key = AddSysCustomKey(key);
            return await Do(db => db.ListLeftPushAsync(key, Serialize(obj)));
        }
        ...
        public bool SortedSetAdd<T>(string key, T obj, double score)
        {
            key = AddSysCustomKey(key);
            return Do(redis => redis.SortedSetAdd(key, Serialize(obj), score));
        }
        ...
        /// <param name="key"></param>
        /// <param name="value"></param>
        public bool SortedSetRemove<T>(string key, T obj)
        {
            key = AddSysCustomKey(key);
            return Do(redis => redis.SortedSetRemove(key, Serialize(obj)));
        }
        ...
        /// <param name="value"></param>
        /// <param name="score"></param>
        public async Task<bool> SortedSetAddAsync<T>(string key, T obj, double score)
        {
            key = AddSysCustomKey(key);
            return await Do(redis => redis.SortedSetAddAsync(key, Serialize<T>(obj), score));
        }
        ...
        /// <param name="key"></param>
        /// <param name="value"></param>
        public async Task<bool> SortedSetRemoveAsync<T>(string key, T obj)
        {
            key = AddSysCustomKey(key);
            return await Do(redis => redis.SortedSetRemoveAsync(key, Serialize<T>(obj)));
        }
        ...
        private string AddSysCustomKey(string oldKey)
        {
            ...
            return build.Append(oldKey).ToString();
        }
        ...
        {
            return _dbProvider.GetDatabase().CreateTransaction();
        }
        ...
        {
            var database = _dbProvider.GetDatabase();
